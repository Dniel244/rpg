class c2Button extends GameObject {
  ...
  c2Button(int x_, int y_, int w_, int h_, color normal_, color highlight_, int t_, String text_, color c_, PImage pI_) {
  ...
  void show() {
    ...
    image(pI, loc.x-10, loc.y, 40, 40);
    image(pI, loc.x+15, loc.y, 40, 40);
