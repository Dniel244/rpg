class c7Button extends GameObject {
  ...
  c7Button(int x_, int y_, int w_, int h_, color normal_, color highlight_, int t_, String text_, color c_, PImage pI_) {
